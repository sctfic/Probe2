...
class StationManager {
    ...
    setLoading(isLoading) {
        if (isLoading) {
            ...
            this.submitBtn.innerHTML = '<div class="spinner" id="spinner"></div><img src="svg/access-control.svg" title="authentification requise!" class="access-control-icon">Ajouter la station';
