    ...
    res.json({
        ...
        endpoints: {
            ...
            station: {
                ...
                compositeConditions: {url:'/api/station/:stationId/composite-conditions/:sensors?', method:'GET'}, //http://probe2.lpz.ovh/api/station/VP2_Serramoune/composite-conditions
