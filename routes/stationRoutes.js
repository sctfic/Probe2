...
// Supprime les données associées à un extender de la station dans InfluxDB
router.delete('/:stationId/extenders/:mac/', isAuthenticated, extendersController.deleteExtenderData);
